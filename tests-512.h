...
void avx512_walking_1(void* const mem, const size_t size);
void avx512_walking_0(void* const mem, const size_t size);
void avx512_checkerboard(void* const mem, const size_t size);
void avx512_address_line_test(void* const mem, const size_t size);
void avx512_anti_patterns(void* const mem, const size_t size);
void avx512_inverse_data_patterns(void* const mem, const size_t size);
