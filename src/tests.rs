    ...
    match isa {
        InstructionSet::AVX512 => {
            ...
            vec![
                ...
                Test { name: "Addressing", passes: 4, iters: 16, run: avx512_addressing },
                ...
                Test { name: "Address Line Test", passes: 2, iters: 1, run: avx512_address_line_test },
        ...
        InstructionSet::AVX2 => {
            ...
            vec![
                ...
                Test { name: "Addressing", passes: 2, iters: 16, run: avx2_addressing },
                ...
                Test { name: "Address Line Test", passes: 2, iters: 1, run: avx2_address_line_test },
